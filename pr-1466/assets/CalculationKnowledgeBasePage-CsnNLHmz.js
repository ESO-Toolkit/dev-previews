import"./rolldown-runtime-B0Z9INg1.js";import{C as e}from"./apollo-Cq3VIBwj.js";import{Co as t,Jo as n,No as r,Po as i,Xa as a,mo as o,qn as s,so as c,ts as l}from"./mui-COrM42CP.js";import{Lt as u}from"./index-Kp_vZXTd.js";import{n as d,t as f}from"./lib-DjaF3zCM.js";e();var p=`# Calculation Knowledge Base\r
\r
...
`,m=l(),h=p.replace(/^# .*?(?:\r?\n)+/,``),g={"& h1":{fontSize:{xs:`1.875rem`,md:`2.25rem`},fontWeight:700,mt:4,mb:2},"& h2":{fontSize:{xs:`1.5rem`,md:`1.875rem`},fontWeight:600,mt:4,mb:1.5},"& h3":{fontSize:{xs:`1.25rem`,md:`1.5rem`},fontWeight:600,mt:3,mb:1.25},"& h4":{fontSize:{xs:`1.1rem`,md:`1.25rem`},fontWeight:600,mt:3,mb:1},"& p":{fontSize:`1rem`,lineHeight:1.7,mb:2},"& ul, & ol":{pl:3,mb:2},"& li":{mb:.75},"& .calculation-table-region":{overflowX:`auto`,mb:3},"& table":{width:`100%`,borderCollapse:`collapse`},"& thead":{backgroundColor:`action.hover`},"& th, & td":{border:e=>`1px solid ${e.palette.divider}`,padding:`8px 12px`,textAlign:`left`,verticalAlign:`top`},"& code":{fontFamily:`Consolas, Monaco, 'Fira Code', monospace`,backgroundColor:`action.hover`,borderRadius:1,px:.5,py:.25,fontSize:`0.95em`},"& pre":{backgroundColor:`action.hover`,borderRadius:2,p:2,overflowX:`auto`,mb:3},"& blockquote":{borderLeft:e=>`4px solid ${e.palette.primary.main}`,pl:2,ml:0,color:`text.secondary`,fontStyle:`italic`,backgroundColor:`action.hover`,py:1,pr:2,borderRadius:1,mb:3},"& a":{color:`primary.main`,fontWeight:600}},_={table:({children:e,...t})=>(0,m.jsx)(`div`,{className:`calculation-table-region`,role:`region`,tabIndex:0,"aria-label":`Calculation reference table`,children:(0,m.jsx)(`table`,{...t,children:e})}),a:({href:e,children:t,...n})=>(0,m.jsx)(a,{...n,href:e,target:`_blank`,rel:`noopener noreferrer`,children:t})},v=()=>{let e=n();return u(`/docs/calculations`),(0,m.jsxs)(o,{maxWidth:`lg`,sx:{py:{xs:4,md:6}},children:[(0,m.jsxs)(t,{sx:{flexDirection:`column`,gap:2,display:`flex`,mb:4},children:[(0,m.jsx)(r,{variant:`h3`,component:`h1`,gutterBottom:!0,sx:{fontWeight:800},children:`Calculation Knowledge Base`}),(0,m.jsx)(r,{variant:`subtitle1`,sx:{color:`text.secondary`},children:`Explore how ESO Toolkit derives combat analytics, where data comes from, and how we transform logs into actionable insights.`}),(0,m.jsxs)(i,{icon:(0,m.jsx)(s,{fontSize:`small`}),severity:`info`,sx:{borderLeft:`4px solid ${e.palette.primary.main}`,backgroundColor:e.palette.mode===`dark`?`rgba(59, 130, 246, 0.12)`:`rgba(59, 130, 246, 0.08)`},children:[`This content mirrors the internal documentation in`,` `,(0,m.jsx)(a,{href:`https://github.com/ESO-Toolkit/eso-toolkit`,target:`_blank`,rel:`noopener noreferrer`,children:`documentation/features/calculations/CALCULATION_KNOWLEDGE_BASE.md`}),`. Updates to the source file are automatically reflected here at build time.`]})]}),(0,m.jsx)(c,{sx:{mb:4}}),(0,m.jsx)(t,{sx:g,children:(0,m.jsx)(d,{remarkPlugins:[f],components:_,children:h})})]})};export{v as CalculationKnowledgeBasePage};