import{a as e}from"./rolldown-runtime-B0Z9INg1.js";import{C as t}from"./apollo-Cq3VIBwj.js";import{$o as n,Ja as r,Ko as i,Mo as a,ao as o,fo as s,jo as c,qn as l,xo as u}from"./mui-DSrtCRJ1.js";import{n as d,t as f}from"./lib-m6xI7wzy.js";var p=e(t()),m=`# Calculation Knowledge Base\r
\r
...
`,h=n(),g=m.replace(/^# .*?(?:\r?\n)+/,``),_={"& h1":{fontSize:{xs:`1.875rem`,md:`2.25rem`},fontWeight:700,mt:4,mb:2},"& h2":{fontSize:{xs:`1.5rem`,md:`1.875rem`},fontWeight:600,mt:4,mb:1.5},"& h3":{fontSize:{xs:`1.25rem`,md:`1.5rem`},fontWeight:600,mt:3,mb:1.25},"& h4":{fontSize:{xs:`1.1rem`,md:`1.25rem`},fontWeight:600,mt:3,mb:1},"& p":{fontSize:`1rem`,lineHeight:1.7,mb:2},"& ul, & ol":{pl:3,mb:2},"& li":{mb:.75},"& .calculation-table-region":{overflowX:`auto`,mb:3},"& table":{width:`100%`,borderCollapse:`collapse`},"& thead":{backgroundColor:`action.hover`},"& th, & td":{border:e=>`1px solid ${e.palette.divider}`,padding:`8px 12px`,textAlign:`left`,verticalAlign:`top`},"& code":{fontFamily:`Consolas, Monaco, 'Fira Code', monospace`,backgroundColor:`action.hover`,borderRadius:1,px:.5,py:.25,fontSize:`0.95em`},"& pre":{backgroundColor:`action.hover`,borderRadius:2,p:2,overflowX:`auto`,mb:3},"& blockquote":{borderLeft:e=>`4px solid ${e.palette.primary.main}`,pl:2,ml:0,color:`text.secondary`,fontStyle:`italic`,backgroundColor:`action.hover`,py:1,pr:2,borderRadius:1,mb:3},"& a":{color:`primary.main`,fontWeight:600}},v={table:({children:e,...t})=>(0,h.jsx)(`div`,{className:`calculation-table-region`,role:`region`,tabIndex:0,"aria-label":`Calculation reference table`,children:(0,h.jsx)(`table`,{...t,children:e})}),a:({href:e,children:t,...n})=>(0,h.jsx)(r,{...n,href:e,target:`_blank`,rel:`noopener noreferrer`,children:t})},y=()=>{let e=i();return p.useEffect(()=>{document.title=`Calculation Knowledge Base | ESO Toolkit`},[]),(0,h.jsxs)(s,{maxWidth:`lg`,sx:{py:{xs:4,md:6}},children:[(0,h.jsxs)(u,{sx:{flexDirection:`column`,gap:2,display:`flex`,mb:4},children:[(0,h.jsx)(c,{variant:`h3`,component:`h1`,gutterBottom:!0,sx:{fontWeight:800},children:`Calculation Knowledge Base`}),(0,h.jsx)(c,{variant:`subtitle1`,sx:{color:`text.secondary`},children:`Explore how ESO Toolkit derives combat analytics, where data comes from, and how we transform logs into actionable insights.`}),(0,h.jsxs)(a,{icon:(0,h.jsx)(l,{fontSize:`small`}),severity:`info`,sx:{borderLeft:`4px solid ${e.palette.primary.main}`,backgroundColor:e.palette.mode===`dark`?`rgba(59, 130, 246, 0.12)`:`rgba(59, 130, 246, 0.08)`},children:[`This content mirrors the internal documentation in`,` `,(0,h.jsx)(r,{href:`https://github.com/ESO-Toolkit/eso-toolkit`,target:`_blank`,rel:`noopener noreferrer`,children:`documentation/features/calculations/CALCULATION_KNOWLEDGE_BASE.md`}),`. Updates to the source file are automatically reflected here at build time.`]})]}),(0,h.jsx)(o,{sx:{mb:4}}),(0,h.jsx)(u,{sx:_,children:(0,h.jsx)(d,{remarkPlugins:[f],components:v,children:g})})]})};export{y as CalculationKnowledgeBasePage};